...
tags: ["mcp", "protocol", "tools", "resources", "typescript", "node", "claude-desktop", "integration"]
use_cases: ["MCP server development", "tool creation", "resource providers", "prompt templates", "MCP integration", "context expansion"]
color: violet
---
